	...
	<el-row class="container">
		...
		<el-col :span="24" class="main">
			...
			<section class="content-container">
				...
				<!--我的消息界面-->
				<el-dialog title="我的消息" v-model="messageVisible" :close-on-click-modal="false">
					<el-form :model="messageForm" label-width="80px" ref="messageForm">
						
					</el-form>
					<div slot="footer" class="dialog-footer">
						<el-button type="primary" @click.native="messageVisible = false">关闭</el-button>
					</div>
				</el-dialog>
				<!--设置界面-->
				<el-dialog title="设置" v-model="settingVisible" :close-on-click-modal="false">
	...
	export default {
		data() {
			return {
				...
				messageVisible: false,//编辑界面是否显示
				settingForm: {

				},
				settingVisible: false,//编辑界面是否显示
				messageForm: {
